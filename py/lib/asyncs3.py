...
class AWSAuthConnection:
    ...
    def put(self, bucket, key, object, headers={}, callback=None, timeout=0):
    ...
    def get(self, bucket, key, headers={}, callback=None, timeout=0):
    ...
    def _make_request(self, method, bucket='', key='', query_args={}, headers={}, data=None, metadata={}, callback=None, timeout=0):
        ...
        url = ('https' if is_secure else 'http') + '://' + host + path
        req = httpclient.HTTPRequest(str(url),
            method=method,
            body=data,
